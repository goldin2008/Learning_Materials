...
#     ...
    ...
    simp_rnn_2 = GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn2')(bn_rnn_1)
...
#     max_pool = MaxPooling1D(pool_size=kernel_size, strides=1, padding='same', name='max_pool')(bn_cnn)
#     bn_cnn = BatchNormalization(name='bn_conv')(max_pool)
...
#             recurrent_dropout=0.2, dropout=0.2), merge_mode='concat')(bn_cnn)
    ...
    bidir_rnn_2 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='bidir_rnn_2'))(bn_rnn_1)
    bn_rnn_2 = BatchNormalization(name='bn_rnn_2')(bidir_rnn_2)
    
#     bidir_rnn_3 = Bidirectional(GRU(units, activation='relu',
#         return_sequences=True, implementation=2, name='bidir_rnn_3'))(bn_rnn_2)
#     bn_rnn_3 = BatchNormalization(name='bn_rnn_3')(bidir_rnn_3)
    
#     bidir_rnn_4 = Bidirectional(GRU(units, activation='relu',
#         return_sequences=True, implementation=2, name='bidir_rnn_4'))(bn_rnn_3)
